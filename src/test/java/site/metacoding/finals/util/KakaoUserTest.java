...
public class KakaoUserTest {
    ...
    // try {
    // oauthToken = objectMapper.readValue(response.getBody(),
    // testOauthKakao.class);
    ...
    // String reqURL =
    // "https://kauth.kakao.com/oauth/authorize?client_id=a471b131916596e9f882cce06006e7a0&redirect_uri=https://kauth.kakao.com/oauth/token&response_type=code";
